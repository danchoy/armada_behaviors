...
class pointCloudPassthroughFilterState(EventState):
        ...
        def execute(self, userdata):
                ...
                request.x_min = int(sys.argv[1])
                request.x_max = int(sys.argv[2])
                request.y_min = int(sys.argv[3])
                request.y_max = int(sys.argv[4])
                request.z_min = int(sys.argv[5])
                request.z_max = int(sys.argv[6])
