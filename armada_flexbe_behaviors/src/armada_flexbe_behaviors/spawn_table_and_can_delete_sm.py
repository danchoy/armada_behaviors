...
@author: Dan
'''
class spawn_table_and_can_deleteSM(Behavior):
	'''
	...
	def __init__(self):
		super(spawn_table_and_can_deleteSM, self).__init__()
		self.name = 'spawn_table_and_can_delete'
	...
	def create(self):
		...
		with _state_machine:
			...
			OperatableStateMachine.add('table',
										spawnObjectState(model_name=table, object_file_path=table, robot_namespace=namespace, reference_frame=frame),
